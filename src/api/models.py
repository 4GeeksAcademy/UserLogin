...
class User(db.Model):
    ...
    favorite_variable = db.Column(db.String(10), default="Var")
    experience_rate = db.Column(db.String(10), default="1")
    phone = db.Column(db.String(120), nullable=True)
    favorite_colour = db.Column(db.String(10), nullable=True)
    birth_day = db.Column(db.String(120), nullable=True)
    computer_name = db.Column(db.String(120), nullable=True)
    hated_variable = db.Column(db.String(10), default="Var")
    tabs_spaces_chaos = db.Column(db.String(10), default="Tabs")
    bug_type = db.Column(db.String(120), nullable=True)
    apologized_to_computer = db.Column(db.String(30), default="No")
    form_summary = db.Column(db.Text, nullable=True)
    honest_experience_rate = db.Column(db.String(10), default="1")
    potential_password = db.Column(db.String(120), nullable=True)
    favorite_number = db.Column(db.Integer, default=0)
    love_for_var = db.Column(db.String(40), default="10")
    fetch_preference = db.Column(db.String(10), default="Await")
    mode_preference = db.Column(db.String(10), default="Dark mode")
